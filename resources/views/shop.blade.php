                ...
                <ul class="list list-inline mb-0">
                  ...
                  <li class="list-item">
                    <span class="menu-link py-1">
                      <input type="checkbox" class="chk-category" name="categories" id="" value="{{ $category->id }}" @if(in_array($category->id, explode(',', $filterCategories))) checked="checked" @endif>
                      {{ $category->name }}
                    </span>
            ...
            <div id="accordion-filter-brand" class="accordion-collapse collapse show border-0"
              ...
              <div class="search-field multi-select accordion-body px-0 pb-0">
                <div class="search-field__input-wrapper mb-3">
                  <input type="text" name="search_text" class="search-field__input form-control form-control-sm border-light border-2" placeholder="Search Brand" />                  
                </div>
                <ul class="list list-inline mb-0 brand-list">
                @foreach($brands as $brand)
                  <li class="list-item">
                    <span class="menu-link py-1">
                      <input type="checkbox" name="brands" value="{{ $brand->id }}" class="chk-brand" @if(in_array($brand->id, explode(',', $filterBrands))) checked="checked" @endif>
                      {{ $brand->name }}
                    </span>
          ...
          <div class="accordion-item mb-4">
            ...
            <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
              ...
              <input class="price-range-slider" type="text" name="price_range" value="" data-slider-min="1"
                data-slider-max="5000" data-slider-step="5" data-slider-value="[{{ $minPrice }}, {{ $maxPrice }}]" data-currency="₹" />
      ...
      <div class="shop-list flex-grow-1">
        ...
        <div class="d-flex justify-content-between mb-4 pb-md-2">
          ...
          <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1">
            <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Items Per Page" name="itemsPerPage" style="margin-right: 20px;" id="itemsPerPage">
              <option value="12" {{ $size == 12 ? 'selected' : '' }}>Show</option>
              <option value="24" {{ $size == 24 ? 'selected' : '' }}>24</option>
              <option value="48" {{ $size == 48 ? 'selected' : '' }}>48</option>
              <option value="102" {{ $size == 102 ? 'selected' : '' }}>102</option>
            </select>
            <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Sort Items" name="sortby" id="sortby">
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="{{ route('shop.product.details', ['productSlug'=>$product->slug]) }}"><img loading="lazy" src="{{ asset('uploads/products') }}/{{ $product->image }}" width="330" height="400" alt="{{ $product->name }}" class="pc__img"></a>
                    </div>
                    <div class="swiper-slide">
                      ...
                      ?>
                      <a href="{{ route('shop.product.details', ['productSlug'=>$product->slug]) }}"><img loading="lazy" src="{{ asset('uploads/products') }}/{{ $cleanImgName }}" width="330" height="400" alt="{{ $product->name }}" class="pc__img"></a>
                      @endforeach
                    </div>
                  </div>
              ...
              <div class="pc__info position-relative">
                ...
                <h6 class="pc__title"><a href="{{ route('shop.product.details', ['productSlug'=>$product->slug]) }}">{{ $product->name }}</a></h6>
...
<script>
  $(function() {
    ...
    $("#itemsPerPage").on("change", function() {
      $("#size").val($("#itemsPerPage option:selected").val());
      $("#frmfilter").submit();
    });

    $("#sortby").on("change", function() {
      $("#order").val($("#sortby option:selected").val());
      $("#frmfilter").submit();
    });
